...
import { getAdditionalServiceById } from 'apiSdk/additional-services';
import { AdditionalServiceInterface } from 'interfaces/additional-service';

function AdditionalServiceViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('additional_service', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/additional-services/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Price Per Hour" text={data?.price_per_hour} />
