  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless transcription with Transcriber. Select your plan, submit your videos, and let us calculate the cost. Explore additional services and finalize your payment with ease. Your transcriptions, edited to perfection, await you in your dashboard."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1476357471311-43c0db9fb2b4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx0cmFuc2NyaXB0aW9ufGVufDB8fHx8MTY5NDk4OTM2Mnww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@edhoradic?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Edho Pratama`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless transcription with Transcriber. Select your plan, submit your videos, and let us calculate the cost. Explore additional services and finalize your payment with ease. Your transcriptions, edited to perfection, await you in your dashboard.`}
            </Text>
            <Box
