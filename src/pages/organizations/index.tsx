...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'additional_service.count', 'payment_plan.count', 'video.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('additional_service', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'additional_service',
          header: 'Additional Service',
          accessorKey: 'additional_service',
          cell: ({ row: { original: record } }: any) => record?._count?.additional_service,
        }
      : null,
    hasAccess('payment_plan', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'payment_plan',
          header: 'Payment Plan',
          accessorKey: 'payment_plan',
          cell: ({ row: { original: record } }: any) => record?._count?.payment_plan,
        }
      : null,
    hasAccess('video', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          header: 'Video',
          accessorKey: 'video',
          cell: ({ row: { original: record } }: any) => record?._count?.video,
        }
      : null,
